<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>  Update Student Details
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="pull-right"><a href="<?php echo base_url() ?>Student/" class="text-muted"><i class="fa fa-close"></i></a></li>
            </ul>
                            ...
                            <div class="row">
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Student_Name" class="form-control" value="<?php echo $row['Student_Name']; ?>" id="sname" name="Student_Name" maxlength="128">
                                    </div>
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Fathers_Name" class="form-control" value="<?php echo $row['Fathers_Name']; ?>" id="fname" name="Fathers_Name" maxlength="128">
                                    </div>
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Mother_Name" class="form-control" value="<?php echo $row['Mother_Name']; ?>" id="mname" name="Mother_Name" maxlength="128">
                                    </div>
                                ...
                                <div class="col-md-3">   
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="group" name="Student_Blood_Group">
                                            <option value="<?php echo $row['Student_Blood_Group']; ?>"><?php echo $row['Student_Blood_Group']; ?></option>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $row['Date_of_Birth']; ?>" id="dob" name="dob" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" placeholder="Sex" value="<?php echo $row['Sex']; ?>" id="Sex" name="Sex">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" placeholder="Community" value="<?php echo $row['Community']; ?>" id="Community" name="Community">
                            ...
                            <div class="row">
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Door_No" value="<?php echo $row['Door_No']; ?>" id="Door_No" name="Door_No" maxlength="128">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="Street_Name">Street_Name</label>
                                        <input type="text" class="form-control" placeholder="Street_Name" value="<?php echo $row['Street_Name']; ?>" id="Street_Name" name="Street_Name" maxlength="128">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="Area_Name">Area_Name</label>
                                        <input type="text" class="form-control" placeholder="Area_Name" value="<?php echo $row['Area_Name']; ?>" id="Area_Name" name="Area_Name" maxlength="128">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
